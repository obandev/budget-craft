...
export default function LoginForm() {
  ...
  return (
    <form action={dispatch} className="space-y-3  pb-4 pt-8">
      ...
      <div className="w-full">
        ...
        <div className="mt-4">
          ...
          <Link
            ...
            className="dark:text-green dark:hover:text-primary-600 pt-2 text-xs font-bold text-gray-900 hover:text-gray-900"
          >
            Forgot password?
          </Link>
        </div>
